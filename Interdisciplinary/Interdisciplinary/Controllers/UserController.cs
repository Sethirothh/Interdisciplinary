...
namespace Interdisciplinary.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(InterdisciplinaryContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,FirstName,LastName,Age,Address,Zip,City")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();
